...
@RestController
@RequestMapping("/api/proxy/inventario") //Ruta para inventario
...
public class InventarioProxyController {
    ...
    public ResponseEntity<?> proxyProductos(
        ...
        String originalPath = request.getRequestURI().replace("/api/proxy/inventario", "");
                            ...
                            //Se deja asi debuido a que la api inventario tiene tres controladores
        String targetUrl = "http://localhost:8084" + originalPath;
