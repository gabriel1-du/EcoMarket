package com.gateway.redireccionApis.Boleta;
...
@RestController
@RequestMapping("/api/proxy/boleta")
@RequiredArgsConstructor
public class BoletaProxyController {
    ...
    public ResponseEntity<?> proxyProductos(HttpServletRequest request,
        ...
        String originalPath = request.getRequestURI().replace("/api/proxy/boleta", "");
        String targetUrl = "http://localhost:8089/api/boleta" + originalPath;
