...
@RestController
@RequestMapping("/api/proxy/carrito") //Ruta para carrito desde el Gateway
...
public class CarritoProxyController {
    ...
    public ResponseEntity<?> proxyProductos(
        ...
        //      "http://localhost:8088/api/carrito" 
        String targetUrl = "http://localhost:8088/api/carrito" + originalPath;
